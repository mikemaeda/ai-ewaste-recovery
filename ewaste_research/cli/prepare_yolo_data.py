"""
ewaste_research/cli/prepare_yolo_data.py
...
ewaste_research/cli/prepare_classifier_data.py, which prepares folders for the Keras *image-classification*
...
(see docs/yolo-workflow.md). If an image has no .txt file, an empty label is written
...
def write_dataset_yaml(output_dir: Path) -> Path:
    ...
    content = (
        f"# Auto-generated by ewaste_research/cli/prepare_yolo_data.py\n"
